...
If the plan suits what you were expecting, deploy in the development environement by runnning:
```bash
...
| [aws_iam_role_policy_attachment.attach_container_permissions_to_ecs_task_role](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| [aws_iam_policy_document.assume_ecs_task_role](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_aws_region"></a> [aws\_region](#input\_aws\_region) | Region in which the resources are deployed | `string` | `"eu-west-3"` | no |
| <a name="input_backend_bucket_name"></a> [backend\_bucket\_name](#input\_backend\_bucket\_name) | Name of the backend bucket | `string` | `"XXXXXXXXXXX"` | no |
